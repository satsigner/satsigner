...
import SSUtxoSelection from '@/components/SSUtxoSelection'
  ...
  return (
    <>
      <GestureHandlerRootView style={{ flex: 1 }}>
          ...
          <SSVStack style={{ flex: 1 }}>
            <SSHStack justifyBetween>
              ...
              <SSIconButton
                onPress={() =>
                  router.navigate(
                    `/account/${id}/signAndSend/selectUtxoBubbles`
                  )
                }
              >
        ...
        >
          ...
          >
            ...
            <SSHStack>
              <SSButton
                variant="outline"
                label={t('transaction.build.edit.input.title')}
                style={{ flex: 1 }}
                onPress={() =>
            ...
            <SSHStack>
              ...
              <SSButton
                variant="outline"
                label={t('transaction.build.change.fee')}
                style={{ flex: 1 }}
                onPress={() => setAddOutputModalVisible(true)}
              />
            </SSHStack>
        ...
        >
          <SSUtxoSelection
            onSave={() => setShowBottomSheet(false)}
            onClose={() => setShowBottomSheet(false)}
          />
        </SSBottomSheet>
