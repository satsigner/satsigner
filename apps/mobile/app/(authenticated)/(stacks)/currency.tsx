        ...
        <SSVStack gap="none" style={styles.currencySection}>
          <SSHStack gap="none" style={styles.rowSeparator}>
            <SSVStack itemsCenter gap="none" style={styles.currencyBlock}>
              <SSText size="md">
                {formatNumber(prices.USD * bitcoin, 2, false, ',')}
              </SSText>
              <SSText size="xs" color="muted">
            ...
            >
              <SSText size="md">
                {formatNumber(prices.EUR * bitcoin, 2, false, ',')}
              </SSText>
              <SSText size="xs" color="muted">
          ...
          <SSHStack gap="none" style={styles.rowSeparator}>
            <SSVStack itemsCenter gap="none" style={styles.currencyBlock}>
              <SSText size="md">
                {formatNumber(prices.GBP * bitcoin, 2, false, ',')}
              </SSText>
              <SSText size="xs" color="muted">
            ...
            >
              <SSText size="md">
                {formatNumber(prices.CAD * bitcoin, 2, false, ',')}
              </SSText>
              <SSText size="xs" color="muted">
          ...
          <SSHStack gap="none" style={styles.rowSeparator}>
            <SSVStack itemsCenter gap="none" style={styles.currencyBlock}>
              <SSText size="md">
                {formatNumber(prices.CHF * bitcoin, 2, false, ',')}
              </SSText>
              <SSText size="xs" color="muted">
            ...
            >
              <SSText size="md">
                {formatNumber(prices.JPY * bitcoin, 2, false, ',')}
              </SSText>
              <SSText size="xs" color="muted">
