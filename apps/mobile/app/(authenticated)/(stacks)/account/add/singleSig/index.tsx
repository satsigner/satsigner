...
export default function SingleSig() {
  ...
  const [localMnemonicWordCount, setLocalMnemonicWordCount] =
    useState<NonNullable<Account['mnemonicWordCount']>>(24)
  ...
  async function handleOnPress(type: 'generate' | 'import') {
    ...
    if (type === 'generate') {
      ...
      setLoading(false)
      router.navigate('/account/add/generate/mnemonic')
    } else if (type === 'import')
      router.navigate('/account/add/import/mnemonic')
  }
