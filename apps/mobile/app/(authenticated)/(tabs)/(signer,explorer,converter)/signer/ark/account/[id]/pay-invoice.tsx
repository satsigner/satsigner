...
import { ArkFeeEstimate } from '@/types/models/Ark'
...
type ArkInvoiceStatsProps = {
  amountSats: number
  btcPrice: number
  feeEstimateQuery: UseQueryResult<ArkFeeEstimate, Error>
  feeSats?: number
  fiatCurrency: string
  totalSats?: number
}

export function ArkInvoiceStats({
  amountSats,
  totalSats,
  btcPrice,
  fiatCurrency,
