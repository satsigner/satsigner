...
function BrantaSettingsPage() {
  ...
  const [verificationMode, logoPrefetchMode, setVerificationMode, setLogoPrefetchMode] =
  ...
  function modeLabel(mode: BrantaTriggerMode, prefix: 'verification' | 'logoPrefetch') {
    if (mode === 'off') {
